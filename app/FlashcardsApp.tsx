...
const LATEST_NEW_CARD_ITALIAN = new Set([
  "aiutare", "alzarsi", "aprire", "arrivare", "bere", "cambiare", "camminare",
  "comprare", "continuare", "costare", "cucinare", "dimenticare", "dire",
  "divertirsi", "dormire", "dovere", "entrare", "finire", "imparare",
  "incontrare", "lasciare", "lavarsi", "mostrare", "offrire", "ordinare",
  "pagare", "passare", "piacere", "portare", "potere", "preferire",
...
const regularPresentConjugations: Record<string, VerbForm[]> = {
  ...
  perdere: presentForms(["perdo", "perdi", "perde", "perdiamo", "perdete", "perdono"]),
  cadere: presentForms(["cado", "cadi", "cade", "cadiamo", "cadete", "cadono"]),
  leggere: presentForms(["leggo", "leggi", "legge", "leggiamo", "leggete", "leggono"]),
  scrivere: presentForms(["scrivo", "scrivi", "scrive", "scriviamo", "scrivete", "scrivono"]),
  conoscere: presentForms(["conosco", "conosci", "conosce", "conosciamo", "conoscete", "conoscono"]),
  credere: presentForms(["credo", "credi", "crede", "crediamo", "credete", "credono"]),
  ricevere: presentForms(["ricevo", "ricevi", "riceve", "riceviamo", "ricevete", "ricevono"]),
  ridere: presentForms(["rido", "ridi", "ride", "ridiamo", "ridete", "ridono"]),
  piangere: presentForms(["piango", "piangi", "piange", "piangiamo", "piangete", "piangono"]),
  rispondere: presentForms(["rispondo", "rispondi", "risponde", "rispondiamo", "rispondete", "rispondono"]),
  chiedere: presentForms(["chiedo", "chiedi", "chiede", "chiediamo", "chiedete", "chiedono"]),
  chiudere: presentForms(["chiudo", "chiudi", "chiude", "chiudiamo", "chiudete", "chiudono"]),
  cuocere: presentForms(["cuocio", "cuoci", "cuoce", "cuociamo", "cuocete", "cuociono"]),
  dipingere: presentForms(["dipingo", "dipingi", "dipinge", "dipingiamo", "dipingete", "dipingono"]),
  decidere: presentForms(["decido", "decidi", "decide", "decidiamo", "decidete", "decidono"]),
  esistere: presentForms(["esisto", "esisti", "esiste", "esistiamo", "esistete", "esistono"]),
  mettere: presentForms(["metto", "metti", "mette", "mettiamo", "mettete", "mettono"]),
  vivere: presentForms(["vivo", "vivi", "vive", "viviamo", "vivete", "vivono"]),
  dipendere: presentForms(["dipendo", "dipendi", "dipende", "dipendiamo", "dipendete", "dipendono"]),
  vedere: presentForms(["vedo", "vedi", "vede", "vediamo", "vedete", "vedono"]),
  vendere: presentForms(["vendo", "vendi", "vende", "vendiamo", "vendete", "vendono"]),
  smettere: presentForms(["smetto", "smetti", "smette", "smettiamo", "smettete", "smettono"]),
  scendere: presentForms(["scendo", "scendi", "scende", "scendiamo", "scendete", "scendono"]),
  ...
  aiutare: presentForms(["aiuto", "aiuti", "aiuta", "aiutiamo", "aiutate", "aiutano"]),
  alzarsi: presentForms(["mi alzo", "ti alzi", "si alza", "ci alziamo", "vi alzate", "si alzano"]),
  aprire: presentForms(["apro", "apri", "apre", "apriamo", "aprite", "aprono"]),
  arrivare: presentForms(["arrivo", "arrivi", "arriva", "arriviamo", "arrivate", "arrivano"]),
  bere: presentForms(["bevo", "bevi", "beve", "beviamo", "bevete", "bevono"]),
  cambiare: presentForms(["cambio", "cambi", "cambia", "cambiamo", "cambiate", "cambiano"]),
  camminare: presentForms(["cammino", "cammini", "cammina", "camminiamo", "camminate", "camminano"]),
  comprare: presentForms(["compro", "compri", "compra", "compriamo", "comprate", "comprano"]),
  continuare: presentForms(["continuo", "continui", "continua", "continuiamo", "continuate", "continuano"]),
  costare: presentForms(["costo", "costi", "costa", "costiamo", "costate", "costano"]),
  cucinare: presentForms(["cucino", "cucini", "cucina", "cuciniamo", "cucinate", "cucinano"]),
  dimenticare: presentForms(["dimentico", "dimentichi", "dimentica", "dimentichiamo", "dimenticate", "dimenticano"]),
  dire: presentForms(["dico", "dici", "dice", "diciamo", "dite", "dicono"]),
  divertirsi: presentForms(["mi diverto", "ti diverti", "si diverte", "ci divertiamo", "vi divertite", "si divertono"]),
  dormire: presentForms(["dormo", "dormi", "dorme", "dormiamo", "dormite", "dormono"]),
  dovere: presentForms(["devo", "devi", "deve", "dobbiamo", "dovete", "devono"]),
  entrare: presentForms(["entro", "entri", "entra", "entriamo", "entrate", "entrano"]),
  finire: presentForms(["finisco", "finisci", "finisce", "finiamo", "finite", "finiscono"]),
  imparare: presentForms(["imparo", "impari", "impara", "impariamo", "imparate", "imparano"]),
  incontrare: presentForms(["incontro", "incontri", "incontra", "incontriamo", "incontrate", "incontrano"]),
  lasciare: presentForms(["lascio", "lasci", "lascia", "lasciamo", "lasciate", "lasciano"]),
  lavarsi: presentForms(["mi lavo", "ti lavi", "si lava", "ci laviamo", "vi lavate", "si lavano"]),
  mostrare: presentForms(["mostro", "mostri", "mostra", "mostriamo", "mostrate", "mostrano"]),
  offrire: presentForms(["offro", "offri", "offre", "offriamo", "offrite", "offrono"]),
  ordinare: presentForms(["ordino", "ordini", "ordina", "ordiniamo", "ordinate", "ordinano"]),
  pagare: presentForms(["pago", "paghi", "paga", "paghiamo", "pagate", "pagano"]),
  passare: presentForms(["passo", "passi", "passa", "passiamo", "passate", "passano"]),
  piacere: presentForms(["piaccio", "piaci", "piace", "piacciamo", "piacete", "piacciono"]),
  portare: presentForms(["porto", "porti", "porta", "portiamo", "portate", "portano"]),
  potere: presentForms(["posso", "puoi", "può", "possiamo", "potete", "possono"]),
  preferire: presentForms(["preferisco", "preferisci", "preferisce", "preferiamo", "preferite", "preferiscono"]),
  prenotare: presentForms(["prenoto", "prenoti", "prenota", "prenotiamo", "prenotate", "prenotano"]),
  preparare: presentForms(["preparo", "prepari", "prepara", "prepariamo", "preparate", "preparano"]),
  prepararsi: presentForms(["mi preparo", "ti prepari", "si prepara", "ci prepariamo", "vi preparate", "si preparano"]),
  provare: presentForms(["provo", "provi", "prova", "proviamo", "provate", "provano"]),
  pulire: presentForms(["pulisco", "pulisci", "pulisce", "puliamo", "pulite", "puliscono"]),
  restare: presentForms(["resto", "resti", "resta", "restiamo", "restate", "restano"]),
  ricordare: presentForms(["ricordo", "ricordi", "ricorda", "ricordiamo", "ricordate", "ricordano"]),
  rimanere: presentForms(["rimango", "rimani", "rimane", "rimaniamo", "rimanete", "rimangono"]),
  riposarsi: presentForms(["mi riposo", "ti riposi", "si riposa", "ci riposiamo", "vi riposate", "si riposano"]),
  sapere: presentForms(["so", "sai", "sa", "sappiamo", "sapete", "sanno"]),
  seguire: presentForms(["seguo", "segui", "segue", "seguiamo", "seguite", "seguono"]),
  servire: presentForms(["servo", "servi", "serve", "serviamo", "servite", "servono"]),
  spedire: presentForms(["spedisco", "spedisci", "spedisce", "spediamo", "spedite", "spediscono"]),
  spendere: presentForms(["spendo", "spendi", "spende", "spendiamo", "spendete", "spendono"]),
  svegliarsi: presentForms(["mi sveglio", "ti svegli", "si sveglia", "ci svegliamo", "vi svegliate", "si svegliano"]),
  vestirsi: presentForms(["mi vesto", "ti vesti", "si veste", "ci vestiamo", "vi vestite", "si vestono"]),
};
...
const cardImagePaths: Record<string, string> = {
  ...
  bere: "card-new/bere.webp",
  cambiare: "card-new/cambiare.webp",
  camminare: "card-new/camminare.webp",
  comprare: "card-new/comprare.webp",
  continuare: "card-new/continuare.webp",
  costare: "card-new/costare.webp",
  cucinare: "card-new/cucinare.webp",
  dimenticare: "card-new/dimenticare.webp",
  dire: "card-new/dire.webp",
  divertirsi: "card-new/divertirsi.webp",
  dormire: "card-new/dormire.webp",
  dovere: "card-new/dovere.webp",
  entrare: "card-new/entrare.webp",
  finire: "card-new/finire.webp",
  imparare: "card-new/imparare.webp",
  incontrare: "card-new/incontrare.webp",
  lasciare: "card-new/lasciare.webp",
  lavarsi: "card-new/lavarsi.webp",
  mostrare: "card-new/mostrare.webp",
  offrire: "card-new/offrire.webp",
  ordinare: "card-new/ordinare.webp",
  pagare: "card-new/pagare.webp",
  ...
  prendere: "card-verbs/prendere.webp?v=1",
  passare: "card-verbs/passare.webp?v=1",
  piacere: "card-verbs/piacere.webp?v=1",
  portare: "card-verbs/portare.webp?v=1",
  potere: "card-verbs/potere.webp?v=1",
  preferire: "card-verbs/preferire.webp?v=1",
  prenotare: "card-verbs/prenotare.webp?v=1",
  correre: "card-verbs/correre.webp?v=1",
  perdere: "card-verbs/perdere.webp?v=1",
  cadere: "card-verbs/cadere.webp?v=1",
  leggere: "card-verbs/leggere.webp?v=1",
  scrivere: "card-verbs/scrivere.webp?v=1",
  conoscere: "card-verbs/conoscere.webp?v=1",
  credere: "card-verbs/credere.webp?v=1",
  ricevere: "card-verbs/ricevere.webp?v=1",
  ridere: "card-verbs/ridere.webp?v=1",
  piangere: "card-verbs/piangere.webp?v=1",
  rispondere: "card-verbs/rispondere.webp?v=1",
  chiedere: "card-verbs/chiedere.webp?v=1",
  chiudere: "card-verbs/chiudere.webp?v=1",
  cuocere: "card-verbs/cuocere.webp?v=1",
  dipingere: "card-verbs/dipingere.webp?v=1",
  decidere: "card-verbs/decidere.webp?v=1",
  esistere: "card-verbs/esistere.webp?v=1",
  mettere: "card-verbs/mettere.webp?v=1",
  vivere: "card-verbs/vivere.webp?v=1",
  dipendere: "card-verbs/dipendere.webp?v=1",
  vedere: "card-verbs/vedere.webp?v=1",
  vendere: "card-verbs/vendere.webp?v=1",
  smettere: "card-verbs/smettere.webp?v=1",
  scendere: "card-verbs/scendere.webp?v=1",
